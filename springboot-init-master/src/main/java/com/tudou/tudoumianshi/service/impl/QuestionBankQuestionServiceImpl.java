...
public class QuestionBankQuestionServiceImpl extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion> implements QuestionBankQuestionService {
    ...
    public QuestionBankQuestionVO getQuestionBankQuestionVO(QuestionBankQuestion questionBankQuestion, HttpServletRequest request) {
        ...
        if (loginUser != null) {
            // 获取点赞
            QueryWrapper<QuestionBankQuestionVO> questionBankQuestionVOQueryWrapper = new QueryWrapper<>();
            questionBankQuestionVOQueryWrapper.in("questionBankQuestionId", questionBankQuestionId);
            questionBankQuestionVOQueryWrapper.eq("userId", loginUser.getId());
        }
        // endregion
    ...
    public Page<QuestionBankQuestionVO> getQuestionBankQuestionVOPage(Page<QuestionBankQuestion> questionBankQuestionPage, HttpServletRequest request) {
        ...
        if (loginUser != null) {
            ...
            // 获取点赞
            QueryWrapper<QuestionBankQuestionVO> QuestionBankQuestionVOQueryWrapper = new QueryWrapper<>();
            QuestionBankQuestionVOQueryWrapper.in("questionBankQuestionId", questionBankQuestionIdSet);
            QuestionBankQuestionVOQueryWrapper.eq("userId", loginUser.getId());
        }
        // 填充信息
